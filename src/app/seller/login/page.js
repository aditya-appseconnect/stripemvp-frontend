...
export default function SellerLogin() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await sellerApi.login(formData.email, formData.password);
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-600">
              ...
              <Link href="/seller/register" className="text-indigo-600 hover:text-indigo-700 font-medium">
                Sign up
              </Link>
            </p>
          </div>

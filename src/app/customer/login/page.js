...
export default function CustomerLogin() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await customerApi.login(formData.email, formData.password);
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 border text-black border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent"
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-600">
              ...
              <Link href="/customer/register" className="text-teal-600 hover:text-teal-700 font-medium">
                Sign up
              </Link>
            </p>
          </div>
